...
const DailyWeightGainChart = () => {
    const data = useSelector((state) => state.WeightData.data)
  return (
    <div className="border border-gray-300 rounded-lg p-4 w-96 bg-white shadow-md">
      {/* Header */}
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-lg font-semibold">Daily Live Weight Gain</h2>
      ...
      <ResponsiveContainer width="100%" height={200}>
        <BarChart data={data} barCategoryGap="30%">
          ...
          <XAxis dataKey="gain" label={{ value: "Number of head / Daily weight gain (kg)", position: "insideBottom", offset: -5 }} />
